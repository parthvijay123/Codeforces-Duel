...
export default function LoginPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-4 relative overflow-hidden">
            ...
            <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-[#c084fc]/10 rounded-full blur-[150px] pointer-events-none" />
            ...
            <div className="w-full max-w-md glass-panel p-10 rounded-[2rem] relative z-10 animate-in zoom-in-95 duration-500">
                <div className="mb-10 text-center flex flex-col items-center">
                    ...
                    <p className="text-gray-400 mt-2 font-medium">Sign in to continue your duels</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-4 mt-2 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-bold rounded-xl shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:shadow-[0_0_30px_rgba(59,130,246,0.5)] transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                ...
                <div className="mt-8 text-center text-sm font-medium text-gray-400">
                    ...
                    <Link href="/signup" className="text-[#00E5FF] hover:text-white transition-colors hover:underline">
                        Create one
                    </Link>
                </div>
            </div>
